            ...
            <div className="flex-1 flex flex-col justify-center max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/auth" className="w-full sm:w-auto">
                  <Button variant="glass" size="lg" className="w-full sm:w-auto text-primary-foreground border-white/20 h-13 sm:h-14 text-base">
                    Get Started Free
          ...
          <div className="bg-card rounded-2xl sm:rounded-3xl shadow-float p-5 sm:p-6 border border-border/50 max-w-md mx-auto">
            <div className="flex items-center justify-between mb-4 sm:mb-5">
              ...
              <div className="flex -space-x-2 sm:-space-x-3">
                {[1, 2, 3].map(i => <div key={i} className="w-9 h-9 sm:w-11 sm:h-11 rounded-full bg-gradient-to-br from-primary to-primary/60 border-2 border-card" />)}
